...
import { useDeleteHouseCategory } from '@/api/house/category/mutations';
import { useGetAllHouseCategoryQuery } from '@/api/house/category/queries';
...
import FormCareer from './components/FormCategory';
import UpdateCareer from './components/UpdateCategory';
...
const CareerAdminPage: NextPageWithLayout = () => {
  ...
  const {
    ...
    isFetching,
    refetch,
  } = useGetAllHouseCategoryQuery(paramsQuery, {
    onError: (error) => toast.error(error.message),
  });
  const { mutate: deleCareer } = useDeleteHouseCategory();
