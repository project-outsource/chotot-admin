...
import { useGetSpecialGuaranteeById } from '@/api/specialiSao-equipment/guarantee/queries';
...
const UpdateCareer = ({ id }: UpdateCareerProps) => {
  ...
  const { data, isFetching } = useGetSpecialGuaranteeById(id, { enabled: isModalOpen });
