...
import { useGetAllHouseAppGuaranteeQueryById } from '@/api/household-appliances/guaranteed/queries';
...
const UpdateCareer = ({ id }: UpdateCareerProps) => {
  ...
  const { data, isFetching } = useGetAllHouseAppGuaranteeQueryById(id, { enabled: isModalOpen });
